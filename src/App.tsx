...
import BullRun from "./pages/BullRun";
    ...
    <BrowserRouter>
      <Routes>
        <Route
          path="/"
          element={
            <Layout mobileMenuOpen={mobileMenuOpen} toggleMenu={toggleMenu} />
          }
        >
          <Route index element={<Home />} />
          <Route path="/courses/futures-trading" element={<FuturesTrading />} />
          <Route
            path="/courses/technical-analysis"
            element={<TechnicalAnalysis />}
          />
          <Route path="/courses/bitcoin-crypto" element={<BitcoinCrypto />} />
          <Route
            path="/courses/wallets-exchanges"
            element={<WalletsExchanges />}
          />
          <Route
            path="/courses/options-trading-masterclass"
            element={<OptionsTradingMasterclass />}
          />
          <Route
            path="/courses/options-trading-basics"
            element={<OptionsTradingBasics />}
          />
          <Route path="/courses/bull-run" element={<BullRun />} />
