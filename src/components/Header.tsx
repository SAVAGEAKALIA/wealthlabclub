      ...
      <header className="fixed w-full bg-primary-dark/90 backdrop-blur-sm z-50 border-b border-gray-800">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <nav className="flex items-center space-x-8">
                <Link
                  to="/"
                  className="text-white hover:text-gradient-mid transition-colors"
                >
                  Home
                </Link>
                <div className="relative group">
                  ...
                  <div className="absolute left-0 mt-2 w-64 rounded-md shadow-lg bg-primary-light border border-gray-800 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                    <div className="rounded-md ring-1 ring-black ring-opacity-5 py-1">
                      <Link
                        to="/courses/futures-trading"
                        className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-primary"
                      >
                        Futures Trading Masterclass
                      </Link>
                      <Link
                        to="/courses/technical-analysis"
                        className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-primary"
                      >
                        Technical Analysis 101
                      </Link>
                      <Link
                        to="/courses/options-trading-masterclass"
                        className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-primary"
                      >
                        Options Trading Masterclass
                      </Link>
                      <Link
                        to="/courses/options-trading-basics"
                        className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-primary"
                      >
                        Options Trading 101
                      </Link>
        ...
        <div className={`md:hidden ${mobileMenuOpen ? "block" : "hidden"}`}>
          <div className="px-2 pt-2 pb-3 space-y-1 bg-primary-dark">
            ...
            <Link
              to="/options-trading-masterclass"
              className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-primary"
            >
              Options Trading Masterclass
            </Link>
            <Link
              to="/options-trading-basics"
              className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-primary"
            >
              Options Trading 101
            </Link>
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1 text-center">
                <p className="text-white font-semibold text-sm md:text-base">
                  Bullrun cohorts coming soon!
                  <span className="ml-2 text-white/90">
                    Join the{" "}
                    <a
                      className="underline"
                      href="https://new-course-bull.web.app/"
                    >
                      waitlist
                    </a>
                  </span>
