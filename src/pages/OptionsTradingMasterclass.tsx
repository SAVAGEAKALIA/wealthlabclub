  ...
  const modules = [
    {
      ...
      lessons: [
        ...
        {
          title: "Welcome to Crypto Futures - Text Summary",
          duration: "",
          type: "text",
        },
      ],
    },
    {
      ...
      lessons: [
        ...
        {
          title: "How to Open a Crypto Futures Position",
          duration: "5:49",
          type: "video",
        },
        {
          title: "Types of Crypto Futures Orders",
          duration: "8:56",
          type: "video",
        },
      ],
    },
    {
      ...
      lessons: [
        ...
        {
          title: "Perpetuals and Funding Rates",
          duration: "3:34",
          type: "video",
        },
        {
          title: "Handle With Care - Text Summary",
          duration: "",
          type: "text",
        },
      ],
    },
    {
      ...
      lessons: [
        {
          title: "BTC Dominance and its Relation to the Alts",
          duration: "5:26",
          type: "video",
        },
        {
          title: "Token Margins vs USDT Margins",
          duration: "7:41",
          type: "video",
        },
      ],
    },
    {
      id: 5,
      title: "Final Metrics",
      lessons: [{ title: "Final Lesson", duration: "", type: "video" }],
    },
  ];
    ...
    <>
            ...
            <div className="md:w-1/2 mb-10 md:mb-0">
              <div className="text-white">
                ...
                <p className="text-lg text-gray-300 mb-6">
                  Master advanced futures trading strategies with our
                  comprehensive course designed for serious traders.
                </p>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-400">
              Our futures trading course is built for traders who are serious
              about mastering the cryptocurrency futures markets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-primary-light p-6 rounded-lg border border-gray-800">
              ...
              <p className="text-gray-400">
                Learn to analyze market data effectively using proven technical
                analysis methods specific to crypto futures.
              </p>
            </div>
            ...
            <div className="bg-primary-light p-6 rounded-lg border border-gray-800">
              ...
              <p className="text-gray-400">
                Develop a systematic approach to managing risk and preserving
                capital in volatile market conditions.
              </p>
            </div>
            ...
            <div className="bg-primary-light p-6 rounded-lg border border-gray-800">
              ...
              <p className="text-gray-400">
                Apply trading theories to actual market scenarios with practical
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-400 mb-10">
              Designed to take you from the basics to advanced futures trading
              concepts with a structured learning path
            </p>
            ...
            <div className="space-y-6">
              {modules.map((module) => (
                <div
                  key={module.id}
                  className="bg-primary p-6 rounded-lg shadow-md border border-gray-800"
                >
            ...
            <div className="lg:w-1/2 text-white order-1 lg:order-2">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold">
                      Crypto Futures Fundamentals
                    </h3>
                    <p className="text-gray-400">
                      Learn what crypto futures are and how they differ from
                      spot trading
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold">
                      Position Opening & Order Types
                    </h3>
                    <p className="text-gray-400">
                      Master all the essential order types and position
                      strategies
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Learn safe position sizing and responsible leverage use
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Understand BTC dominance and different margin types
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-full mb-8 md:mb-0 text-white">
                    ...
                    <p className="text-gray-300 mb-6">
                      Join our comprehensive masterclass and transform your
                      trading skills with proven strategies and expert guidance.
                    </p>
      ...
      <section className="py-16 bg-primary">
        <div className="container">
          ...
          <div className="flex flex-col items-center justify-center lg:flex-row gap-8 max-w-6xl mx-auto">
            {/* Annual Plan */}
            ...
            {/* <div className="bg-primary/50 border border-gray-700 rounded-lg p-4 mb-6 backdrop-blur-sm">
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-gradient-mid mr-3 mt-0.5" />
                      <span className="text-gray-300">
                        Save $239.18 on your subscription
                      </span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-gradient-mid mr-3 mt-0.5" />
                      <span className="text-gray-300">
                        Just $59.80 for a full year access
                      </span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-gradient-mid mr-3 mt-0.5" />
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 text-white">
              ...
              <p className="text-gray-300 mb-6">
                Join the Wealth Lab Affiliate Program and earn generous
                commissions by referring students to our premium trading
                courses. Leverage your network and help others succeed while
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Receive substantial commissions on every successful
                      referral
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Access professional banners, email templates, and
                      promotional content
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Track your performance with detailed reporting and
                      analytics
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Extended tracking period to maximize your earnings
                      potential
                    </p>
                  </div>
                </div>
